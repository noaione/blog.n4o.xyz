...
<GitHubCode
  user="noaione"
  repo="express-sql-workshop"
  filepath="public/static/js/loginApp.js"
  noLineNumbers
/>
...
<GitHubCode
  user="noaione"
  repo="express-sql-workshop"
  filepath="public/static/js/registerApp.js"
  noLineNumbers
/>
...
<Video src="https://p.ihateani.me/zrayqnku.mp4" caption="Safeguard example" />
...
<GitHubCode
  user="noaione"
  repo="express-sql-workshop"
  filepath="public/static/js/dashboardApp.js"
  noLineNumbers
/>
...
- `enablePassModBtn` and `disablePassModBtn` is a function to disable/enable our modifier button
