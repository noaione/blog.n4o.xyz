...
<Admonition type="info" title="Jika tidak bisa install via MS Store">
  <span className="mr-1">Ikuti cara install melalui LxRunOffline di sini: </span>
  <Link href="/posts/lxrunoffline" locale="id">
