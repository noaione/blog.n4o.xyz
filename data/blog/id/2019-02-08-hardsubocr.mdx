...
<Image src="/static/images/ocrhard/01.png" caption="Atur Cropping" />
...
<Image src="/static/images/ocrhard/02.png" caption="Atur Cropping (2)" />
...
<Image src="/static/images/ocrhard/03.png" caption="Encode script" />

Setelah di save, drag n' drop file `YoloCR.vpy` ke script `encode-cropped.bat` tadi, lalu tunggu sampai encode selesai

<Image src="/static/images/ocrhard/04.png" caption="Encoding..." />
...
<Image src="/static/images/ocrhard/05.png" caption="Proses OCR" />
