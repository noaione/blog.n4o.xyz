        ...
        <div className="text-xs text-gray-500 flex" style={{ marginRight: '0.75rem' }}>
          {loadedData.language && (
            <div className="mr-4 gap-2">
              <span
                className="rounded-full inline-block relative"
                style={{
                  backgroundColor: this.state.colors[loadedData.language].color,
                  width: '0.75rem',
                  height: '0.75rem',
                  top: '1px',
                }}
              />
              <span style={{ marginLeft: '0.25rem' }}>{loadedData.language}</span>
            </div>
          )}
